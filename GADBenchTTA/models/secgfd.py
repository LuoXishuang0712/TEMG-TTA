...
class SECGFDWrapped(SECGFD):
    def __init__(self, in_feats, graph, num_classes=2, h_feats=32, d=2, high_order=2, **kwargs):
        super().__init__(in_feats, h_feats, num_classes, graph, d, high_order)
    
    def forward(self, graph: dgl.DGLGraph):
        h, _ = super().forward(graph.ndata['feature'])
        return h
